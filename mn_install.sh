...
CIRCUIT_LATEST_RELEASE="https://github.com/CircuitProject/Circuit-Project/releases/download/v4.1.1/circuit-4.1.1-ubuntu1804-daemon.zip"
...
function copy_circuit_binaries(){
  ...
  unzip  circuit-4.1.1-ubuntu1804-daemon.zip
